/*	Задание: 
	...
	(Или на любой из страниц категории, например http://rozetka.com.ua/usb-flash-memory/c80045/page=4/)
	...
	P.S. На розетке не корректно отображается количество показанных товаров
*/
